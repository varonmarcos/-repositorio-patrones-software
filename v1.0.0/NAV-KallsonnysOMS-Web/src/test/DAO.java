...
public class DAO {
	...
	public TableResultDTO<CustomerDTO> getClients(TableFilterDTO filterDTO){
	...
	public CustomerDTO editCliente(){
		CustomerDTO cli = new CustomerDTO();
    	cli.setId(getRandomLong());
    	cli.setName(getRandomNames());
    	cli.setSurname(getRandomNames());
	...
	private List<AddressDTO> getClientAddress(){
    	...
    	address.setStateName("Antioquia");
    	address.setCityName("Medellin");
    	...
    	address1.setId(1L);
    	address1.setCountry(CountryEnum.USA);
    	address1.setAddresstype(AddressTypeEnum.BILLING_ADDRESS);
    	address1.setStateName("Texas");
    	address1.setCityName("Dallas");
