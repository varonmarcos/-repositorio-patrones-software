...
public class ProductServices_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/macbook/Documents/BUS-KallsonnysOMS-WS/war/WEB-INF/wsdl/productServices.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ProductServices_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/Users/macbook/Documents/BUS-KallsonnysOMS-WS/war/WEB-INF/wsdl/productServices.wsdl");
        }
        WSDL_LOCATION = url;
    }
